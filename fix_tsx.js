...
const files = {
  'frontend/src/components/shell/Sidebar.tsx': import React from 'react';
import './shell.css';
      ...
      {analysisId && (
        <div className="sidebar-case-context">
          ...
          <div className="case-context-meta">
            {imageMetadata?.modality || 'MRI'} &bull; {imageMetadata?.dimensions ? \\ x \\ : '512 x 512'}
          </div>
          {isCalibrated && (
...
,
  'frontend/src/components/shell/TopBar.tsx': import React from 'react';
...
,
  'frontend/src/pages/Anatomy.tsx': import React, { useState } from 'react';
...
,
  'frontend/src/pages/CaseOverview.tsx': import React, { useRef } from 'react';
              ...
              <div className="co-panel">
                ...
                <div className="co-meta-grid">
                  ...
                  <div className="co-meta-item">
                    ...
                    <span className="co-meta-val">{imageMetadata?.dimensions ? \\ x \\ : '512 x 512'}</span>
                  </div>
                  <div className="co-meta-item">
